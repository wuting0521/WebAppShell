...
extern const NSString * ToastPositionKeyboardAbove;
extern const NSString * ToastPositionTabbarAbove;
...
/**
 ...
 @param position The toast's center point. Can be one of the predefined ToastPosition
...
/**
 Creates a new instance of `ToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `ToastStyle`.
 */
...
/**
 ...
 with with a nil style. By default, this is set to `ToastStyle`'s default
 style.
...
/**
 ...
 Default is `ToastPositionBottom`.
 
 @param position The default center point. Can be one of the predefined
 ToastPosition constants or a `CGPoint` wrapped in an `NSValue` object.
 */
+ (void)setDefaultPosition:(id)position;

/**
 Returns the default toast position. Default is `ToastPositionBottom`.
