...
#define kWebViewJavascriptBridgeErrorDomain  @"WebViewJavascriptBridgeErrorDomain"
#define kWebViewJavascriptBridgeErrorAPIKey  @"APIName"

typedef NS_ENUM(NSUInteger, WebViewJavascriptBridgeErrorCode) {
    kWebViewJavascriptBridgeError_UnsupportedAPI,
};
...
- (void)_flushMessageQueueWithError:(NSError **)error;
